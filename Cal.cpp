...
/* Problemas a resolver
	...
	//Falta agora completar os cases da função iniciar_matriz
	//Fazer um algoritmo caso que caso não seja fornecido o mês, imprima o calendario de todos os meses daquele ano.
	...
	switch(d)
	{
		case 1:
			...
			for(int i=0; i<5; i++)
				for(int j=0; j<6; j++)
				{	
					//para mudar o dia da semana que o dia 1 começa, é só mudar o j, 1 é segunda feira e assim por diante
					if(i==0&&j==0)
						j=1;
